...
class Texty(ConstrainedControl):
    """
    Texty is a control for displaying text.
    ...
    def main(page: ft.Page):
        page.title = "Texty examples"

        page.add(
            ft.Texty("Size 10", size=10),
            ft.Texty("Size 30, Italic", size=20, color="pink600", italic=True),
            ft.Texty("Limit long text to 2 lines and fading", style=ft.TextThemeStyle.HEADLINE_SMALL),
            ft.Texty(
